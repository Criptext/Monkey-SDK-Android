...
public class CriptextDBHandler {
    ...
    public static int getNmessageNuevosConversation(String id){
        Realm realm = CriptextLib.instance().getMonkeyKitRealm();
        return realm.where(MessageModel.class).equalTo("_uid_sent", id).equalTo("_status", "porabrir").findAll().size();
    }
